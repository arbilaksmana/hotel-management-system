  ...
  return (
    <div>
      ...
      <div className="mb-3 flex items-center justify-between gap-4">
        ...
        <p className="hidden shrink-0 text-xs text-muted-foreground sm:block">{visibleRooms.length} kamar · {DAYS} hari</p>
      </div>
        ...
        <table className="w-full border-collapse text-xs">
          ...
          <thead>
            <tr>
              ...
              {dates.map((d) => (
                <th key={d} className="sticky top-0 z-20 min-w-20 border-b bg-card px-2 py-2.5 text-center font-medium">
